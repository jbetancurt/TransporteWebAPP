...
import { TiposDePlantillasOfertasComponent } from './componentes/tipos-de-plantillas-ofertas/tipos-de-plantillas-ofertas.component';
...
@NgModule({
  declarations: [
    ...
    TiposDePlantillasOfertasComponent,
